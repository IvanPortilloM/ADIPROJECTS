...
- **DsCA** (9; EN CURSO): ✅ frmDetProducto (4846b1d), ✅ frmDetCredito (c271e0d; patrón SP-39-OUTPUTs → diccionario con DynamicParameters), ✅ frmCarnetImp (7a8fcaf), ✅ frmBuscarAsociados (d7d7544). Faltan: SAC\frmMenu (222), Herramientas\frmDevoluciones (311), IA\Transaccionales\frmInformacionAsoc (958, también usa DsCodeasAdiggm), SAC\FrmSolCred (1926) + VarGlobales.consultasCA.
