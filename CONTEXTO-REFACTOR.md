...
## 13. TAREA INMEDIATA
Continuar **DsCA**: siguiente `IA\Transaccionales\frmInformacionAsoc` (958 líneas; migrar su parte DsCA y evaluar si también la parte DsCodeasAdiggm con RepositorioCodeas), luego FrmSolCred; al final reemplazar `VarGlobales.consultasCA` y borrar `DsCA.xsd`. UN form por turno; **análisis de errores de lógica en cada form (§0)**, los GRAVES se reparan en la migración; build verde + commit + actualizar §6/§9/§12/§13. **Gotcha §11 en todo Designer con grid.**
