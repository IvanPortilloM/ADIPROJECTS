...
- **DsCA** (9; EN CURSO): ✅ frmDetProducto (4846b1d), ✅ frmDetCredito (c271e0d; patrón SP-39-OUTPUTs → diccionario con DynamicParameters), ✅ frmCarnetImp (7a8fcaf), ✅ frmBuscarAsociados (d7d7544), ✅ SAC\frmMenu (328455b), ✅ frmDevoluciones (9fc54bb; estrenó **RepositorioCodeas** p/DsCodeasAdiggm incremental), ✅ frmInformacionAsoc (c1fa738; su parte DsCodeasAdiggm —estado de cuenta— también migrada a RepositorioCodeas). Falta: SAC\FrmSolCred (1926) + VarGlobales.consultasCA → borrar DsCA.xsd.
