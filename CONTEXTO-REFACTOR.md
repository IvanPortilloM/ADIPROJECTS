...
- **DsFAC** (11, EN CURSO — conexión TransporteAdiggm, `RepositorioFAC` creado 9aa7b5f): ✅ FAC_TipoMoneda (9aa7b5f), ✅ FAC_CAI (e91b4a1). Pendientes: FAC_Productos, FAC_TipoFacUsuarios, FAC_TipoFacturas, FAC_ReporteCierres, FAC_BusquedaViajes, FAC_Factura, FAC_VisorFacturas, SAC\frmClientesRTN + VarGlobales.consultasFAC.
