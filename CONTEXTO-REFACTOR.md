...
- **DsFAC** (11, EN CURSO — conexión TransporteAdiggm, `RepositorioFAC` creado 9aa7b5f): ✅ FAC_TipoMoneda (9aa7b5f), ✅ FAC_CAI (e91b4a1), ✅ FAC_TipoFacturas (6cf66a7). Pendientes: FAC_Productos, FAC_TipoFacUsuarios, FAC_ReporteCierres, FAC_BusquedaViajes, FAC_Factura, FAC_VisorFacturas, SAC\frmClientesRTN + VarGlobales.consultasFAC. (El XSD tiene otros adapters de FAC_TipoFacturas: por usuario y con fila "Todos" — los usan los forms transaccionales, cubrir al migrarlos.)
