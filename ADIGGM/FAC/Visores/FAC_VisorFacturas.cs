...
namespace ADIGGM.FAC.Visores
{
    public partial class FAC_VisorFacturas : FrmPrincipal
    {
        ...
        private void FAC_VisorFacturas_Load(object sender, EventArgs e)
        {
            ...
            this.fAC_TipoFacturasTableAdapter.FillByTodos(this.dsFAC.FAC_TipoFacturas);
            this.tR_ClientesTableAdapter.FillByTodos(this.dsFAC.TR_Clientes);
            this.fAC_FacturasVisorTableAdapter.Fill(this.dsFAC.FAC_FacturasVisor, dtpDesde.Value.Date, dtpHasta.Value.Date, int.Parse(cboTipoFactura.SelectedValue.ToString()), int.Parse(cboCliente.SelectedValue.ToString()), txtFiltro.Text);

            if (dgvFactura.Rows.Count > 0)
            {
                this.fAC_FacturaDetVisorTableAdapter.Fill(this.dsFAC1.FAC_FacturaDetVisor, int.Parse(dgvFactura.CurrentRow.Cells[0].Value.ToString()));
            }
        }
        ...
        private void btnVisualizar_Click(object sender, EventArgs e)
        {
            ...
            {
                this.fAC_FacturaDetVisorTableAdapter.Fill(this.dsFAC1.FAC_FacturaDetVisor, 0);
            }
        }
        ...
        {
            Transacciones.FAC_Factura tran = new Transacciones.FAC_Factura();
        ...
        private void anularToolStripMenuItem_Click(object sender, EventArgs e)
        {
            ...
            {
                Clases.VarGlobales.consultasFAC.FAC_FacturaAnular(int.Parse(dgvFactura.CurrentRow.Cells[0].Value.ToString()), Clases.VarGlobales.Usuario);
