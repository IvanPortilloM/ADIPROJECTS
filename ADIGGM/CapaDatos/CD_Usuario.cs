                ...
                try
                {
                    ...
                    while (leerXML.Read())
                    {
                        ...
                        if (doc.Element("PERMISOS") != null)
                        {
                            ...
                            (from menu in doc.Element("PERMISOS").Elements("DetalleMenu").Elements("Menu")
                             select new Menu()
                             {
                                 Nombre = menu.Element("Nombre").Value,
                                 NombreFormulario = menu.Element("NombreFormulario").Value,
                                  ...
                                  select new SubMenu()
                                  {
                                      ...
                                      (from detsubmenu in menu.Element("DetalleSubMenu").Elements("SubMenu").Elements("DetalleSubMenuNieto").Elements("SubMenuNieto")
                                       select new SubMenuNieto()
                                       {
                                           ...
                                           NombreFormulario = detsubmenu.Element("NombreFormulario").Value,
                                           NombreMenu = detsubmenu.Element("NombreMenu").Value
